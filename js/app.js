(() => {
    ...
    (() => {
        ...
        function hasPermission(db, cat) {
            return db.some((item => {
                const [category, permission] = item.split("_");
                return category === "*" && permission === "allow" && permission !== "deny" || category === cat && permission === "allow";
            }));
        }
        console.log(hasPermission([ "*_allow", "books_allow", "games_deny" ], "games"));
        console.log(hasPermission([ "books_allow", "movies_deny" ], "movies"));
        console.log(hasPermission([ "books_allow", "movies_deny" ], "books"));
        console.log(hasPermission([ "*_allow", "*_deny" ], "movies"));
